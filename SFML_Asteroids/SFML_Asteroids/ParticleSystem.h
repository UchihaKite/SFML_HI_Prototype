...
{
public:
	ParticleSystem(float Count, sf::Vector2f Position, sf::Color Color, float Size, int Spread, float Angle, float Speed, int SpeedSpread, std::shared_ptr<SoundManager> SoundManager, std::shared_ptr<TextureManager> TextureManager);
